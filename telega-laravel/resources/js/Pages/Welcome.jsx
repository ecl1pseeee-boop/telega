                ...
                <div className="relative flex min-h-screen flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end items-center gap-2">
                                {auth.user ? (
                                    <>
                                        <Link
                                            href="/chat"
                                            className="rounded-full bg-[#FF2D20] px-6 py-2.5 text-white font-semibold transition hover:bg-[#FF2D20]/90 shadow-lg"
                                        >
                                            Перейти к чатам
                                        </Link>
                                        <Link
                                            href={route('dashboard')}
                                            className="rounded-md px-3 py-2 text-black transition hover:text-black/70 dark:text-white"
                                        >
                                            Dashboard
                                        </Link>
                                    </>
                        ...
                        <div className="my-12 grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                { title: "Защита", desc: "Сквозное шифрование вашей переписки" },
                                { title: "Синхронизация", desc: "Доступ к чатам со всех устройств" },
                                { title: "Безопасность", desc: "Поддержка 2FA и OAuth авторизации" }
                            ].map((feature, i) => (
                                <div key={i} className="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
                                    <h3 className="font-bold text-lg mb-2 text-[#FF2D20]">{feature.title}</h3>
